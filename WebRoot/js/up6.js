...
function HttpUploaderMgr()
{
	...
	this.Config = {
		...
		//文件夹操作相关
		, "UrlFdCreate"		: "http://localhost:8080/Uploader6.3SQL/db/fd_create_uuid.jsp"
		, "UrlFdComplete"	: "http://localhost:8080/Uploader6.3SQL/db/fd_complete.jsp"
		, "UrlFdDel"	    : "http://localhost:8080/Uploader6.3SQL/db/fd_del.jsp"
		//文件操作相关
		, "UrlCreate"		: "http://localhost:8080/Uploader6.3SQL/db/f_create.jsp"
		, "UrlPost"			: "http://localhost:8080/Uploader6.3SQL/db/f_post.jsp"
        , "UrlProcess"		: "http://localhost:8080/Uploader6.3SQL/db/f_process.jsp"
		, "UrlComplete"		: "http://localhost:8080/Uploader6.3SQL/db/f_complete.jsp"
		, "UrlList"			: "http://localhost:8080/Uploader6.3SQL/db/f_list.jsp"
		, "UrlDel"			: "http://localhost:8080/Uploader6.3SQL/db/f_del.jsp"
	    //x86
        , ie: {
