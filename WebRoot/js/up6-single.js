...
function HttpUploaderMgr()
{
	...
	this.Config = {
        ...
        , "Cookie"			: ""//服务器cookie
		//文件夹操作相关
		, "UrlFdCreate"		: "http://localhost:8080/Uploader6.2SQL/db/fd_create.jsp"
		, "UrlFdComplete"	: "http://localhost:8080/Uploader6.2SQL/db/fd_complete.jsp"
		, "UrlFdDel"	    : "http://localhost:8080/Uploader6.2SQL/db/fd_del.jsp"
		//文件操作相关
		, "UrlCreate"		: "http://localhost:8080/Uploader6.2SQL/db/f_create.jsp"
		, "UrlPost"			: "http://localhost:8080/Uploader6.2SQL/db/f_post.jsp"
		, "UrlComplete"		: "http://localhost:8080/Uploader6.2SQL/db/f_complete.jsp"
		, "UrlList"			: "http://localhost:8080/Uploader6.2SQL/db/f_list.jsp"
		, "UrlDel"			: "http://localhost:8080/Uploader6.2SQL/db/f_del.jsp"
	    //x86
        , ie: {
